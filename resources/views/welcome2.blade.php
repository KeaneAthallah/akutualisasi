        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <!-- Stats Cards -->
                    <div id="statsCards" class="grid grid-cols-3 md:grid-cols-3 gap-6 p-6 mb-6" style="display: none;">
                        ...
                        <div
                            class=" hidden bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl p-6 text-white shadow-lg">
